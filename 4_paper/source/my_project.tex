...
\begin{figure}[!htp]
    ...
    \includegraphics[width=0.7\textwidth]{../input/figure_city.jpg}
...
\begin{figure}[!htp]
    ...
    \includegraphics[width=0.7\textwidth]{../input/figure_hwy.jpg}
...
\begin{table}[htp]
    \centering
    \caption{\bf{Clustered standard errors regression results}}
    \label{tab:clustered-regression}
